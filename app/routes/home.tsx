      ...
      <div className="home">
          ...
          <section className="hero">
              ...
              <p className="subtitle">
                  Roomfix is an AI-first design environment that helps you visualize, render, and ship architectural projects faster  than ever.
              </p>
                      ...
                      <div className="project-card group">
                          ...
                          <div className="card-body">
                              <div>
                                  ...
                                  <div className="meta">
                                      <Clock size={12} />
                                      <span>{new Date('06.03.2026').toLocaleDateString()}</span>
                                      <span>By Ceala Digital Limited</span>
                                  </div>
                              </div>
                              <div className="arrow">
